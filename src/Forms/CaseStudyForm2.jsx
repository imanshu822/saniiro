        ...
        <form onSubmit={handleSubmit}>
          ...
          <Stack gap={2} mt={2}>
            ...
            >
              ...
              >
                ...
                <Stack direction={"row"} gap={1}>
                  <input type="checkbox" id="socialMedia" value="socialMedia" />
          ...
          <Stack gap={2} mt={2}>
            ...
            >
              ...
              >
                <Stack direction={"row"} gap={1}>
                  <input type="checkbox" id="opportunity" value="opportunity" />
                  <label for="opportunity">Opportunity/Deal Management</label>
                </Stack>
                <Stack direction={"row"} gap={1}>
                  <input type="checkbox" id="forecasting" value="forecasting" />
          ...
          <Stack gap={2} mt={2}>
            ...
            >
              ...
              >
                ...
                <Stack direction={"row"} gap={1}>
                  <input type="checkbox" id="pageLayouts" value="pageLayouts" />
